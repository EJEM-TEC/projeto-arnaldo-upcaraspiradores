        ...
        <div className="min-h-screen bg-black px-4 py-8">
            ...
            <div className="mb-8">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full bg-white rounded-4xl p-4 flex items-center justify-center gap-3 shadow-lg disabled:opacity-50"
                >
                    ...
                    <span className="text-gray-900 font-medium text-sm">Cadastrar com Google</span>
                </button>
            </div>
